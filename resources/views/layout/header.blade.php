...
<div class="header" style=" background-color: #114944;">
            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="{{asset('uploads/theme_images/1.jpg')}}">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{{route('profile',Auth::guard('web')->user()->username)}}"
                            ...
                            <a href="javascript:void(0);" id="clearCache" class="dropdown-item ai-icon">
                                <svg id="icon-refresh" xmlns="http://www.w3.org/2000/svg" class="text-success"
                                    width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path
                                        d="M21 12.78a9 9 0 1 0-3.84 3.84L20.67 15a7 7 0 1 1-3.3-3.3M23 12v-2h-5v2h4.14A9.1 9.1 0 0 1 21 12h2z">
                                    </path>
                                </svg>
                                <span class="ms-2">Clear Cache</span>
                            </a>
