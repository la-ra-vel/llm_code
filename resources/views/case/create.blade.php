...
<style>
    ...
    .custom-tab-1 .nav-tabs .nav-link.active {
        ...
        border-color: #dee2e6 #dee2e6 transparent;
        border-bottom: 3px solid #F93A0B;
    }
        ...
        <div>
            <div>
                ...
                <div class="custom-tab-1">
                    <ul class="nav nav-tabs bg-white rounded-top shadow-sm" id="myTab" role="tablist">
                        ...
                        foreach ($roles as $key => $value) {
                            ...
                            // echo "<pre>"; print_r($permissionCheck); exit;
                            $permissionRole[] = [
                                'access' => @$permissionCheck->access
                            ];
                        }
                        // echo "<pre>"; print_r($permissionRole); exit;
                        ?>
                        @if(@$permissionRole[0]['access'] == 1)
                        <li class="nav-item" role="presentation">
...
<script src="{{asset('js/new_case/court_details.js')}}"></script>
<script src="{{asset('js/new_case/fee_details.js')}}"></script>
<script src="{{asset('js/new_case/action_details.js')}}"></script>
<script src="{{asset('js/new_case/payment_details.js')}}"></script>
<script src="{{asset('js/new_case/document_details.js')}}"></script>
