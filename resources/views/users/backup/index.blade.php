    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <h4>
                <a class="btn btn-rounded btn-info" href="{{route('user.create')}}"><span class="btn-icon-start text-info"><i class="fa fa-plus color-info"></i>
                </span>Add</a>
                </h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="users-table" style="min-width: 845px; width: 100%;">
